...
I have tried both method, Imputation and Capping, Imputation did not removed the outlier, it has added another one.
Capping worked perfect, hence we will use capping method for outlier treatment.
we will use method 2, that is Impuation to replace outliers.
